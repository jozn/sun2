...
func main() {
	...
	cd := []string{
		...
		`protoc --plugin=protoc-gen-grpc-java=C:\Go\_gopath\src\ms\sun\scripts\protoc-gen-grpc-java-1.4.0-windows-x86_64.exe --java_out=D:\ms\social\proto\src\main\java --grpc-java_out=lite:D:\ms\social\proto\src\main\java *.proto`,
