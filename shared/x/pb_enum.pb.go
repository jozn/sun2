...
func (UserOnlinePrivacyEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (PostTypeEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (PostCategoryEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func (NotifyEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
...
func (ActionEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{9} }
...
func (ProfilePrivacyLevelEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{10} }
...
func (RoomTypeEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{11} }
...
func (RoomActionDoingEnum) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{12} }
