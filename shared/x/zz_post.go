...
) // (shortname .TableNameGo "err" "res" "sqlstr" "db" "XOLog") -}}//(schema .Schema .Table.TableName) -}}// .TableNameGo}}// Post represents a row from 'ms.post'.
...
func (p *Post) Delete(db XODB) error {
	...
	// sql query
	const sqlstr = `DELETE FROM ms.post WHERE PostId = ?`
